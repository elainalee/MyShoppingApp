...
class TopSection extends StatelessWidget {
  ...
  const TopSection(this._tabController, {Key key, this.tabList, this.userViewModel}) : super(key: key);
        ...
        Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text("Pineapple", style: Theme.of(context).textTheme.headline2),
              Text("Admin's recommendation",
